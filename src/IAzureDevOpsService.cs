...
public interface IAzureDevOpsService
{
    ...
    Task<IReadOnlyList<WorkItemClassificationNode>> GetAreasAsync(string projectName, int? depth = null, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional cancellation token</param>
    /// <returns>Areas</returns>
    Task<IReadOnlyList<WorkItemClassificationNode>> GetIterationsAsync(string projectName, int? depth = null, CancellationToken cancellationToken = default);

    /// <summary>
    /// Retrieve the accessible stored queries
    /// </summary>
    /// <param name="projectName">Optional project name to scope to</param>
    /// <param name="depth">Depth to retrieve</param>
    ...
    Task<IReadOnlyList<QueryHierarchyItem>> GetStoredQueriesAsync(string projectName, int? depth, bool? includeDeleted = null, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional cancellation token</param>
    /// <returns></returns>
    Task<QueryHierarchyItem> GetStoredQueryDetailsAsync(string projectName, QueryHierarchyItem item,
        int? depth, bool? includeDeleted = false, CancellationToken cancellationToken = default);

    /// <summary>
    /// Execute a specific stored query
    /// </summary>
